...
import pl.edu.wat.crochetshopapi.model.GmailCredential;
import pl.edu.wat.crochetshopapi.model.GoogleTokenResponse;
...
public class GmailAPIService {
    ...
    public boolean sendMessage(String subject, String body) throws MessagingException, IOException {
